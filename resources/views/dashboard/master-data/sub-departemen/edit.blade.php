                    ...
                    <form id="formData">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <select style="width: 100%" id="iDepartemen" name="departemen" required>
                                <option value="{{ $data->id_dept }}" selected="selected">{{ $data->departemen }}</option>
                                </select>
                            </div>  
                
                            <div class="form-group">
                            <label>ID Sub Departemen</label>
                                <input name="idSubDepartemen" type="text" class="form-control" value="{{ $data->id_subDepartemen }}" readonly>
                            </div>

                            <div class="form-group">
                            <label>Nama Sub-Departemen</label>
                                <input name="subDepartemen" type="text" class="form-control" value="{{ $data->sub_departemen }}">
                            </div>
