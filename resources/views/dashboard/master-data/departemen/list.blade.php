                ...
                <div class="card">
                    ...
                    <div class="card-footer bg-whitesmoke">
                        <div class="row justify-content-end">
                            ...
                            <div class="col-sm-12 col-lg-2 mt-2 mt-lg-0">
                                <a href="{{ url('dashboard/master/departemen') }}" class="btn btn-block btn-primary">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            let listTable = $('#listTable').DataTable({
                ...
                ajax: {
                    url: '{{ url('dashboard/master/departemen/data') }}'
                },
                columns: [
                    {data: 'isDell',
            ...
            btnEdit.click(function (e) {
                e.preventDefault();
                window.location = '{{ url('dashboard/master/departemen/edit') }}/'+dataID;
            })
        });
    </script>
@endsection
