                    ...
                    <form id="formData">
                        <input type="hidden" name="type" value="baru">
                            ...
                            <div class="form-group">
                                <label>Tanggal</label>
                                <input type="text" class="form-control" id="iTanggalAwal" name="tanggal">
                            </div>
                            <div class="form-group">
                                <label>Nama Event</label>
                      
                                    <input type="text" class="form-control" name="event" id="eveny"/>
    ...
    <script type="text/javascript">          
        ...
        $(document).ready(function () {
            ...
            formData.submit(function (e) {
                e.preventDefault();
                $.ajax({
                    url: '{{ url('dashboard/master/event-tahunan/submit') }}',
                    method: 'post',
                    data: $(this).serialize(),
                    success: function (response) {
                        if (response === 'success') {
                            Swal.fire({
                                ...
                                timer: 1000,
                                onClose: function () {
                                    window.location = '{{ url('dashboard/master/event-tahunan') }}';
                                }
                            });
                        } else {
