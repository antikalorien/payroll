                    ...
                    <form id="formData">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input name="id_variable" type="text" class="form-control" value="{{ $data->idVariable }}" readonly>
                            </div>
                            <div class="form-group">
                                <label>Ord</label>
                            ...
                            <div class="form-group">
                                ...
                                <input name="variable" type="text" class="form-control" value="{{ $data->variable }}">
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            formData.submit(function (e) {
                e.preventDefault();
                $.ajax({
                    url: '{{ url('dashboard/system-utility/group-sub-variable/submit') }}',
                    method: 'post',
                    data: $(this).serialize(),
                    success: function (response) {
                        if (response === 'success') {
                            Swal.fire({
                                ...
                                timer: 1000,
                                onClose: function () {
                                    window.location = '{{ url('dashboard/system-utility/group-sub-variable/list') }}';
                                }
                            });
                        } else {
