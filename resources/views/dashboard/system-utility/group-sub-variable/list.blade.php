    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            let listTable = $('#listTable').DataTable({
                ...
                ajax: {
                    url: '{{ url('dashboard/system-utility/group-sub-variable/list/data') }}'
                },
                columns: [
                    {data: 'status',
        ...
        btnDisable.click(function (e) {
                e.preventDefault();
                    ...
                    if (result.value) {
                        $.ajax({
                            url: '{{ url('dashboard/system-utility/group-sub-variable/disable') }}',
                            method: 'post',
                            data: {id_variable: dataID},
            ...
            btnActivate.click(function (e) {
                e.preventDefault();
                    ...
                    if (result.value) {
                        $.ajax({
                            url: '{{ url('dashboard/system-utility/group-sub-variable/activate') }}',
                            method: 'post',
                            data: {id_variable: dataID},
                            success: function (response) {
                                console.log(response);
