    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            let listTable = $('#listTable').DataTable({
                ...
                ajax: {
                    url: '{{ url('dashboard/system-utility/group/list/data') }}'
                },
                columns: [
                    {data: 'status',
            ...
            btnEdit.click(function (e) {
                e.preventDefault();
                window.location = '{{ url('dashboard/system-utility/group/edit') }}/'+dataID;
            })
             ...
             btnDisable.click(function (e) {
                e.preventDefault();
                    ...
                    if (result.value) {
                        $.ajax({
                            url: '{{ url('dashboard/system-utility/group/disable') }}',
                            method: 'post',
                            data: {id_group: dataID},
            ...
            btnActivate.click(function (e) {
                e.preventDefault();
                    ...
                    if (result.value) {
                        $.ajax({
                            url: '{{ url('dashboard/system-utility/group/activate') }}',
                            method: 'post',
                            data: {id_group: dataID},
                            success: function (response) {
                                console.log(response);
