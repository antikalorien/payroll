            ...
            <div class="col-12 col-md-12 col-lg-5">
                <div class="card profile-widget">
                    <div class="profile-widget-header">
                        <img alt="image" src="{{ (isset($data['profile']->foto)) ? url('storage/'.$data['profile']->foto) : asset('assets/img/avatar/avatar-3.png') }}" class="rounded-circle profile-widget-picture">
                    ...
                    <form id="formEdit">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col-4">
                                    <img alt="image" src="{{ asset('assets/img/avatar/avatar-3.png') }}" class="rounded-circle profile-widget-picture" id="iPreviewFoto" style="width: 100%">
                                </div>
                                <div class="col-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="iAlamat" value="agung" rows="4" style="height: 137px"></textarea>
                                    </div>
